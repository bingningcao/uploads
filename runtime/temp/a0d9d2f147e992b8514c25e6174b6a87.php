<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./themes/default/mobile/order\ajax_order_list.html";i:1619057717;}*/ ?>
        ...
        <?php endforeach; endif; else: echo "" ;endif; ?>
         <div class="uc-summary clearfix" style='padding:8px 7px;text-align:right;'>
           ...
           <?php } if($orders['order']['order_status_id']==config('default_order_status_id')){ ?>             
                ...
                <?php if($o['total'] == '0.00'):?>
                    <a class="olbtn wepay wepay_button" href="javascript:;" data-id="<?php echo $orders['order']['order_id']; ?>" style="border: 1px solid red; color: red;">审核中</a> 
                <?php else:?>
                ...
                <?php endif;}elseif($orders['order']['order_status_id']==config('paid_order_status_id')){ ?> 
